...
func TestEnsureCodexMcpConfigEmptyClearsBlock(t *testing.T) {
	...
	got := string(data)
	if strings.Contains(got, aiocCodexMcpBeginMarker) {
...
func TestEnsureCodexMcpConfigWritesManagedBlock(t *testing.T) {
	...
	if !strings.Contains(got, aiocCodexMcpBeginMarker) || !strings.Contains(got, aiocCodexMcpEndMarker) {
